      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-xl">
            <h3 className="text-xl text-gray-700 font-semibold mb-2">Basic Salary</h3>
            <p className="text-gray-600 dark:text-gray-400">Fixed part of your earnings.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-xl">
            <h3 className="text-xl text-gray-700 font-semibold mb-2">Allowances</h3>
            <p className="text-gray-600 dark:text-gray-400">HRA, DA, and other allowances.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-xl">
            <h3 className="text-xl text-gray-700 font-semibold mb-2">Deductions</h3>
